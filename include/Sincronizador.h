...
class Sincronizador
{
    ...
    public:
        ...
        */
        void ordenaLista(list<int> &listaNaoOrdenada);
        ...
        */
        void acumuladorDeListas(list<int> &listaParaAcumular, list<int> &listaAcumulada);
        ...
        */
        void desdobraListas (list<int> &listaParaDesdobrar, int numeroDeRepeticoes, list<int> &listaResultante);
        void desdobraListas (list<string> &listaParaDesdobrar, int numeroDeRepeticoes, list<string> &listaResultante);
        ...
        */
        void uneListas(list<int> &lista1, list<int> &lista2, list<int> &listaUnida);
        ...
        */
        void removeRepeticoes(list<int> &listaComRepeticoes, list<int> &listaSemRepeticoes);
        ...
        */
        void calculaDerivadaDiscreta (list<int> &listaParaDerivar, list<int> &listaDerivadaDiscreta);
